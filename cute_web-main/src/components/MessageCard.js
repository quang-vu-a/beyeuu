...
const messages = [
    "Gửi đến người con gái tuyệt vời nhất trong cuộc đời anh, nhờ có iem mỗi ngày của anh đều là ngày hạnh phúc nhatt.",
    "Thiệt raa, đây là lần đầu anh đón 1 ngày 8/3 với ngyeu đấy nên anh có thể có sai sót 1 xiuuu mong là bé yeuu sẽ hỏng trách phạt anhhh ",
    "Nhưng màaa, anh sẽ cố gắng hết sức để tạo cho iem 1 ngày 8/3 thiet nhiều ý nghĩa nhaaaa",
    "Anh muốn chúng mình cứ mãi vô tư và hồn nhiên như này, có thể anh có những thiếu sót trong câu chuyện tình của chúng ta mong em hãy chỉ bảo để chúng ta càng hiểu nhau hơn nhéee",
    "Bé yeuu ơiii chúng ta hãy tạo nên 1 chuyện tình thanh xuân thiệt là đáng nhớ nheeee",
    "Anh yeuu em nhattt"
];
